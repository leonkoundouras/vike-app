...
function Page() {
  return /* @__PURE__ */ jsxs("div", { style: { padding: "20px", fontFamily: "Arial, sans-serif" }, children: [
    /* @__PURE__ */ jsx("h1", { children: "About This App" }),
    /* @__PURE__ */ jsx("p", { children: "This application demonstrates:" }),
    /* @__PURE__ */ jsxs("ul", { children: [
      /* @__PURE__ */ jsx("li", { children: "Server-side rendering with Vike" }),
      /* @__PURE__ */ jsx("li", { children: "Express.js backend" }),
      /* @__PURE__ */ jsx("li", { children: "React components" }),
      /* @__PURE__ */ jsx("li", { children: "File-based routing" })
    ] }),
